...
export function BasePanel({ base, units, onBuildUnit }: BasePanelProps) {
  ...
  return (
    <div className="panel w-full">
      ...
      <div className="mb-4">
        <div className="text-xs text-tactical-blue mb-1">Health</div>
        ...
        <div className="text-xs text-tactical-yellow mt-1">
      ...
      {baseUnits.length > 0 && (
        <div className="mb-4">
          <div className="text-sm text-tactical-blue font-semibold mb-2">Units</div>
          <div className="space-y-1">
            {baseUnits.map((unit) => (
              <div key={unit.id} className="text-xs flex justify-between">
                <span>{unit.type}</span>
                <span className="text-tactical-yellow">×{unit.quantity}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {onBuildUnit && (
        <div className="mt-4">
          <div className="text-xs text-tactical-blue font-semibold mb-2">Build Units</div>
